...
function drawSelect(i){
    ...
    elem.style.setProperty("background", "rgb(0, 123, 255)", null); // Bootstrap primary color
}

function drawAltSelect(i){
    var diagram = document.getElementById("content").childNodes;
    var elem = diagram.item(i);
    elem.style.setProperty("background", "rgb(23, 162, 184)", null); // Bootstrap info color
}

function drawUnselect(i, j){
    var diagram = document.getElementById("content").childNodes;
    var elem = diagram.item(i);
    elem.style.setProperty("background", "rgb(30, 30, 30)", null); // Bootstrap secondary color
}
...
function drawSorted(i){
    ...
    sorted.style.setProperty("background", "rgb(40, 167, 69)", null); // Bootstrap success color
}
